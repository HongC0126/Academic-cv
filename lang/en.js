...
const enHomePageData = {
  name: " Hong(Cindy) Chen ",
  jobTitle: " Research Technician ",
  home_title: "About me",
  home_content: `
  <div>
    <p> With a strong interest in Information Technology, I earned my Master of Information Systems Management in December 2023. During my first internship at China Unicom, I focused on developing unit tests using Python (Pytest) and contributed to CI/CD pipeline development.
Since August 2023, I have been involved in building unit tests for the NetworkAnalysis application and supporting early-stage development of a sleep stage classification project. Beginning in January 2024, I transitioned to an imaging science–related role, where I worked on data transfer, data cleaning, and model training.
Since January 2025, I have been working with aging datasets, analyzing brain anatomical surface changes, as well as contributing to clinical studies involving multimodal EEG and fMRI data from infants and toddlers.
    </p>
